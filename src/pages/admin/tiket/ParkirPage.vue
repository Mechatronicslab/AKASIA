  ...
  <q-page class="q-pa-md">
    <div class="col">
      <q-item-label
        ...
        >Main Parkir</q-item-label
      >
      <q-item-label
        style="font-size: 12px"
        class="text-caption text-grey-6 q-mb-md"
        >Halaman visualiasi data harga parkir yang terdaftar di dalam
        sistem.</q-item-label
      >
    </div>
    <q-card class="my-card q-pa-md">
            ...
            <q-item clickable v-ripple>
              <q-item-section>
                <q-item-label caption class="text-weight-medium q-mb-xs"
                  >Total jenis parkir</q-item-label
                >
                <q-item-label
      ...
      <q-item-label
        ...
        >Table data jenis parkir</q-item-label
      >
      <q-item-label
        style="font-size: 12px"
        class="text-caption text-grey-6 q-mb-md"
        >Seluruh data jenis harga parkir yang terdaftar dalam
        sistem.</q-item-label
      >
      ...
      <q-card style="width: 600px; max-width: 80vw">
        <q-form @submit="onSubmit()" class="q-gutter-md">
          <q-card-section class="bg-blue-10 text-white">
            <div class="text-h6">TAMBAH DATA HARGA PARKIR</div>
          ...
          <q-card-section class="q-pt-none">
            <div class="row items-start">
              <q-input
                ...
                label="Jenis Parkir ex: Mobil, Motor"
                dense
                lazy-rules
                :rules="defaultRules"
              >
    ...
    <q-dialog v-model="editDialog">
      <q-card style="width: 600px; max-width: 80vw">
        <q-form @submit="onEdit()" class="q-gutter-md">
          <q-card-section class="bg-blue-10 text-white">
            <div class="text-h6">UBAH DATA HARGA PARKIR</div>
            <div class="text-caption">
              Pastikan melakukan pengecekan data sebelum merubah data.
            </div>
          </q-card-section>
