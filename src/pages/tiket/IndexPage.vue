    ...
    <div class="row">
      <div class="col">
        <div class="col">
          ...
          >
            Seluruh jenis tiket masuk yang terdaftar di sistem.
          </q-item-label>
        </div>
              ...
              >
                <div class="col">
                  ...
                  <q-card class="q-mt-sm q-pa-sm" style="width: 139px">
                    <div
                      class="text-caption ellipsis text-capitalize text-weight-bold"
                    >
                      {{ props.row.label }}
                    </div>
        ...
        <q-card class="bg-grey-3 q-pa-sm q-px-md q-py-md" flat>
          <div class="col">
            ...
            <q-item-label
              style="font-size: 12px"
              class="text-caption text-grey-6 q-mb-md"
              >Pesanan tiket pelanggan.</q-item-label
            >
          </div>
          ...
          <div v-else>
            <q-list separator class="q-mt-md">
              ...
              >
                ...
                <q-item-section>x {{ d.beliItem }}</q-item-section>
                <q-item-section>{{
      ...
      <q-card class="my-card">
            ...
            <div class="col">
              <div class="row q-py-sm">
                ...
                <div class="col text-weight-medium q-ml-md">
                  <q-item-label
                    style="font-size: 16px"
                    class="text-weight-bold text-indigo-10 q-mb-md text-capitalize"
        ...
        <div class="bg-blue-grey-10 text-white q-py-sm">
          <div class="row flex flex-center">
            ...
            <q-btn class="q-mr-md q-ml-md bg-white text-blue-grey-10 q-py-sm" @click="this.onCheckout()"
              >Checkout</q-btn
            >
          </div>
        </div>
...
`;
    ...
    insertData() {
      this.form.totalBayar = this.totalBelanja;
      this.form.detailPesanan = this.keranjangBelanja;
      this.$axios
        .post("transaksitiket/create", this.form)
        .finally(() => this.$q.loading.hide())
        .then((response) => {
          if (!this.$parseResponse(response.data)) {
